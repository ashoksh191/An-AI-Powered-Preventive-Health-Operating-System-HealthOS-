...
Please use this state to answer the user's health questions or give insights. Maintain a professional, warm, supportive tone, and include standard medical disclaimers where appropriate.`;
      ...
      if (!modelResponse) {
        ...
        // 0. EMERGENCY FIRST-AID & INJURY PROTOCOLS (Stroke, Acidity, Heartburn, Nosebleed, Minor Cuts, Wounds, Burns, Sprains, Fainting)
        else if (msgLower.includes('stroke') || msgLower.includes('stoke') || msgLower.includes('lakwa') || msgLower.includes('paralysis') || msgLower.includes('brain attack') || msgLower.includes('face droop') || msgLower.includes('slurred speech')) {
          modelResponse = `🚨 **CRITICAL EMERGENCY PROTOCOL FOR STROKE / BRAIN ATTACK (स्ट्रोक / लकवा):**\n\nA stroke is an acute medical emergency requiring immediate hospitalization within the 3-hour thrombolysis window!\n\n**Remember F.A.S.T:**\n1. **F - Face:** Ask the person to smile. Does one side of the face droop?\n2. **A - Arms:** Ask the person to raise both arms. Does one arm drift downward?\n3. **S - Speech:** Ask the person to repeat a simple phrase. Is their speech slurred or strange?\n4. **T - Time:** If you observe ANY of these signs, call Emergency Services (102 / 108 / 911) IMMEDIATELY!\n\n**Immediate Action:**\n- Keep the person lying flat with head slightly elevated (15-30 degrees).\n- Do NOT give any water, food, or aspirin by mouth.\n- Note the exact time symptoms first started for ER doctors.`;
        }
        else if (msgLower.includes('acidity') || msgLower.includes('heartburn') || msgLower.includes('heart burn') || msgLower.includes('gerd') || msgLower.includes('reflux') || msgLower.includes('acid') || msgLower.includes('jalan') || msgLower.includes('gastric') || msgLower.includes('gas') || msgLower.includes('tejab') || msgLower.includes('tezaab') || msgLower.includes('dakar') || msgLower.includes('belch')) {
          modelResponse = `🤢 **Clinical Protocol for Acidity, Heartburn & Gastric Relief (एसिडिटी & सीने में जलन):**\n\n1. **Immediate Natural Buffers:**\n   - Sip a glass of cold skimmed milk, cold water, or fresh buttermilk (छाछ) with a pinch of roasted cumin (Jeera).\n   - Sip warm Jeera (cumin) or Saunf (fennel) infused water to soothe gastric mucosal lining.\n2. **Posture Protocol:**\n   - Sit upright for at least 45 to 60 minutes after eating. **NEVER lie down or slump immediately after a meal**, as gravity keeps stomach acid from flowing up into your esophagus.\n   - Elevate the head of your bed by 6 inches if heartburn strikes at night.\n3. **Dietary Adjustments:**\n   - Avoid fried, oily, spicy foods, citrus fruits, raw onions, caffeine, sodas, and chocolate.\n   - Eat smaller, frequent meals instead of 3 heavy meals.\n4. **OTC Medical Relief:** Take a fast-acting antacid syrup/chewable (Gelusil/Digene) or an H2 blocker / PPI (e.g. Pantoprazole 40mg taken 30 mins before breakfast) as advised by your doctor.\n5. **Red Flag Warning:** If burning sensation is accompanied by sweating, shortness of breath, or pain radiating to left arm/jaw, seek emergency care to rule out a heart condition!`;
        }
        else if (msgLower.includes('constipation') || msgLower.includes('kabz') || msgLower.includes('kabj') || msgLower.includes('hard stool') || msgLower.includes('bowel')) {
          modelResponse = `🚽 **Clinical Protocol for Constipation Relief (कब्ज से राहत):**\n\n1. **Soluble Fiber Intake:** Consume 25-30g of dietary fiber daily (Psyllium husk / Isabgol with warm water before bed, oats, flaxseeds, lentils, and apples/prunes).\n2. **Hydration:** Drink 3.5 Liters of water daily. Dehydration is the primary cause of hard, painful bowel movements.\n3. **Morning Protocol:** Drink 2 glasses of warm water immediately upon waking up to stimulate peristaltic bowel reflexes.\n4. **Physical Activity:** 20-30 minutes of daily brisk walking stimulates gut motility.`;
        }
        else if (msgLower.includes('diarrhea') || msgLower.includes('diarrhoea') || msgLower.includes('loose motion') || msgLower.includes('dast') || msgLower.includes('vomiting') || msgLower.includes('ulti')) {
          modelResponse = `🌊 **Clinical Protocol for Diarrhea & Loose Motions (दस्त & उल्टी का इलाज):**\n\n1. **ORS Rehydration:** Sip WHO ORS (Oral Rehydration Solution) or fresh coconut water continuously after every loose stool to prevent dehydration.\n2. **BRAT Diet:** Eat soft, binding foods: Bananas, Boiled Rice with Curd (dahi-chawal), Applesauce, and Toast.\n3. **Avoid Trigger Foods:** Strictly avoid dairy milk, caffeine, sugary sodas, oily/spicy dishes, and raw salads until 24 hours after recovery.\n4. **Probiotics:** Take a probiotic supplement (Enterogermina / Sporlac) to restore healthy gut microbiome balance.\n5. **Red Flags:** Seek emergency care if stool contains blood/mucus, fever exceeds 102°F, or signs of severe dehydration occur.`;
        }
        else if (msgLower.includes('cramp') || msgLower.includes('cramps') || msgLower.includes('spasm') || msgLower.includes('nas pe nas')) {
          modelResponse = `⚡ **Clinical Protocol for Muscle Cramps & Spasms (मांसपेशियों में खिंचाव / क्रैम्प):**\n\n1. **Gentle Stretch:** Gently stretch the cramped muscle in the opposite direction and hold for 30 seconds.\n2. **Electrolyte Replenishment:** Sip electrolyte water rich in Magnesium, Potassium, and Sodium (Coconut water or ORS).\n3. **Warm Compress:** Apply a warm towel or heating pad to relax tight muscle fibers.`;
        }
        else if (msgLower.includes('toothache') || msgLower.includes('tooth pain') || msgLower.includes('dant') || msgLower.includes('daanth') || msgLower.includes('gum')) {
          modelResponse = `🦷 **Clinical Guidance for Toothache & Gum Relief (दाँत दर्द से राहत):**\n\n1. **Warm Salt Water Gargle:** Rinse mouth thoroughly with warm salt water for 60 seconds to kill bacteria and reduce inflammation.\n2. **Clove Oil Application:** Dab a small cotton swab with 1-2 drops of Clove Oil (लौंग का तेल) directly on the aching tooth for natural eugenol anesthetic relief.\n3. **Cold Pack:** Hold an ice pack on the outside of your cheek for 15 minutes.\n4. **Dentist Visit:** Schedule a dental consultation if pain persists beyond 24 hours.`;
        }
        else if (msgLower.includes('sunstroke') || msgLower.includes('heatstroke') || msgLower.includes('heat stroke') || msgLower.includes('lu lagna') || msgLower.includes('loo')) {
          modelResponse = `☀️ **Emergency First-Aid for Sunstroke & Heat Stroke (लू लगना / हीटस्ट्रोक):**\n\n1. **Move to Cool Shade:** Immediately bring the person to a cool, shaded or air-conditioned room.\n2. **Active Cooling:** Apply cool wet towels to the head, neck, armpits, and groin area. Use a fan to circulate cool air.\n3. **Rehydration:** Sip cold ORS solution, coconut water, or Sattu/Aam Panna.\n4. **Emergency:** If the person is confused, vomiting, or loses consciousness, call 102/108/911 emergency services immediately!`;
        }
